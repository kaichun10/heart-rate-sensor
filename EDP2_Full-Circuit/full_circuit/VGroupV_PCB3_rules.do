...
rule PCB (clearance 20 (type smd_smd))
rule PCB (clearance 20 (type smd_pin))
rule PCB (clearance 20 (type smd_via))
rule PCB (clearance 20 (type pin_pin))
rule PCB (clearance 20 (type pin_via))
rule PCB (clearance 20 (type via_via))
rule PCB (clearance 5 (type test_test))
rule PCB (clearance 20 (type test_wire))
rule PCB (clearance 20 (type test_smd))
rule PCB (clearance 20 (type test_pin))
...
set mhole_pin off
rule PCB (clearance 20 (type bbvia_testpin))
...
################################################################################
rule net GND (width 40)
rule net VCC (width 40)
